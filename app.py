...
def main():
    ...
    if not st.session_state.assessment_complete:
        ...
        if not st.session_state.user_info_collected:
            ...
            st.markdown(f'<p style="color: {st.session_state.primary_color};"><strong>Please enter your details to begin the assessment (First two fields with * are required)</strong></p>', unsafe_allow_html=True)
